...
export class ArchiveComponent implements OnInit {
  ...
  showSection(form: NgForm){
    // console.log(form)
    // alert('Hiiiiiiiiiiii ' + form.value.fontStyle)
    if(form.value.fontStyle == 'completed'){
      this.openCompleted = true;
      this.openPending = false;
    }else if(form.value.fontStyle == 'overdue'){
